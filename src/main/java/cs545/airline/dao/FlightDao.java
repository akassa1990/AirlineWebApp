...
//  Couldn't figure out another way to inject the persistence context
	...
	@SuppressWarnings("unchecked")
	public List<Flight> findByDepartureBetween(Date dateFrom,  Date timeFrom, Date dateTo, Date timeTo) {
		Query query = entityManager.createQuery(
	...
	@SuppressWarnings("unchecked")
	public List<Flight> findByArrivalBetween(Date dateFrom,Date timeFrom,  Date dateTo, Date timeTo) {
		Query query = entityManager.createQuery(
